...
export type GetCategoryContentQueryVariables = Types.Exact<{
    id: Types.Scalars['String'];
    pageSize: Types.Scalars['Int'];
    currentPage: Types.Scalars['Int'];
    sort: Types.ProductAttributeSortInput;
    onServer: Types.Scalars['Boolean'];
    filter: Types.ProductAttributeFilterInput;
}>;

export type GetCategoryContentQuery = {
